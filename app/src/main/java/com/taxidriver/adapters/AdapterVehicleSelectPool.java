...
public class AdapterVehicleSelectPool extends BaseAdapter {
    ...
    String carId;
    AdapterVehicleSelect.UpdateVehiclInterface updateVehiclInterface;

    public AdapterVehicleSelectPool(Context mContext, ArrayList<ModelVehicle.Result> vehicleList, Dialog dialog, AdapterVehicleSelect.UpdateVehiclInterface updateVehiclInterface, String carId) {
