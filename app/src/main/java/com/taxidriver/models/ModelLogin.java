...
public class ModelLogin implements Serializable {
    ...
    public class Result implements Serializable {
        ...
        private String expiry_pan_date;

        private String expiry_driving_lisence_date;
        ...
        public String getLisence_status() {
            return lisence_status;
        }

        public void setLisence_status(String lisence_status) {
            this.lisence_status = lisence_status;
        }

        public String getExpiry_pan_date() {
            return expiry_pan_date;
        }

        public void setExpiry_pan_date(String expiry_pan_date) {
            this.expiry_pan_date = expiry_pan_date;
        }

        public String getExpiry_driving_lisence_date() {
            return expiry_driving_lisence_date;
        }

        public void setExpiry_driving_lisence_date(String expiry_driving_lisence_date) {
            this.expiry_driving_lisence_date = expiry_driving_lisence_date;
        }
