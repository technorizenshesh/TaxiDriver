...
public class ModelUserPoolRequests implements Serializable {
    ...
    public class Result implements Serializable {
        ...
        private String pool_request_id;
        ...
        public void setPool_request_id(String pool_request_id) {
            this.pool_request_id = pool_request_id;
        }

        public String getPool_request_id() {
            return this.pool_request_id;
        }
